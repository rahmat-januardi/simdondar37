...
<body OnLoad="document.prolis.noktg.focus();">
    ...
    if (isset($_POST[cari])) {
        ...
        if (($stokkantong['Status'] == '2' || $stokkantong['Status'] == '3') and ($stokkantong['sah'] == '1') and ($stokkantong['statQC'] == '0') and ($stokkantong['statKonfirmasi'] == '1') and ($stokkantong['produk'] == 'PRC')) {
