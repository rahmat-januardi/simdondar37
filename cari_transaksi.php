...
umur, beratBadan, tensi, suhu, nadi, Hb, JenisDonor, Pengambilan, petugas, petugasHB, petugasTensi from htransaksi where NoKantong='$_GET[kode]'");
echo '{"barang": ';
	...
	$petugas=$barang1['petugas'];
	$petugasHB=$barang1['petugasHB'];
	$petugasTensi=$barang1['petugasTensi'];
