...
header("Content-Disposition: attachment; filename=qc-wb-all.xls");
...
<font size="4" color=00008B></b></font><br><br>
	...
	<table border=1 cellpadding=4  style="border-collapse:collapse">
	    ...
	    <th rowspan="4" colspan="3" >UDD PUSAT PMI</th>
  	    <th colspan="2" colspan="8" >LEMBAR DATA ANALISA UJI MUTU KOMPONEN DARAH LENGKAP (WB)</th>
	    <th rowspan="4" align="left" style="width:155px;">Halaman <br/>Nomor <br/>Versi <br/>Tanggal Berlaku <br/>Tanggal Kajiulang</th>
	    <th rowspan="4" colspan="2" align="left" style="width:190px;">: 1 dari 1 <br/>: UDDP-PM-L3-046 <br/>: 004 <br/>: 01/07/2018 <br/>: 01/07/2020</th>
