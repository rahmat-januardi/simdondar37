...
header("Content-Disposition: attachment; filename=qc-lpaferesis-all.xls");
...
<font size="4" color=00008B></b></font><br><br>
	...
	<table border=1 cellpadding=4  style="border-collapse:collapse">
	    ...
	    <th rowspan="4" colspan="3" >UDD PUSAT PMI</th>
  	    <th colspan="2" colspan="8" >LEMBAR DATA ANALISA UJI MUTU KOMPONEN DARAH PLASMA AFERESIS (LP AFERESIS)</th>
	    <th rowspan="4" align="left" style="width:155px;">Halaman <br/>Nomor <br/>Versi <br/>Tanggal Berlaku <br/>Tanggal Kajiulang</th>
	    <th rowspan="4" colspan="2" align="left" style="width:190px;">: 1 dari 1 <br/>: UDDP-PM-L3-052 <br/>: 004 <br/>: 01/07/2020 <br/>: 01/07/2022</th>
...
<tr style="font-size:12px; color:#000000;">
	...
	$nama_udd=mysql_fetch_assoc(mysql_query("select * from utd where id='$tmp[asal_utd]'"));
	    ...
	    <td class="str" align="center"><?=$tmp['vaktorviii']?></td>
...
<!--<td align="center"><b><?=$aerobwb ?>%</b></td>
<td align="center"><b><?=$anaerobwb ?>%</b></td>-->
...
<table align="right" border=1 cellpadding=4  style="border-collapse:collapse">
        <tr style="font-size:12px; color:#000000;">
	    <th colspan="2" align="left">Catatan : *Standar Kelulusan* <br/>Kadar Leukosit = < 0,07 x 10<sup>9</sup> /L
