...
header("Content-Disposition: attachment; filename=qc-prc-leucodepleted-all.xls");
...
<font size="4" color=00008B></b></font><br><br>
	...
	<table border=1 cellpadding=4  style="border-collapse:collapse">
	    ...
	    <th rowspan="4" colspan="3" >UDD PUSAT PMI</th>
  	    <th colspan="2" colspan="8" >LEMBAR DATA ANALISA UJI MUTU KOMPONEN DARAH MERAH PEKAT (PRC-Leucodepleted)</th>
	    <th rowspan="4" align="left" style="width:155px;">Halaman <br/>Nomor <br/>Versi <br/>Tanggal Berlaku <br/>Tanggal Kajiulang</th>
	    <th rowspan="4" colspan="2" align="left" style="width:190px;">: 1 dari 1 <br/>: UDDP-PM-L3-048 <br/>: 004 <br/>: 01/07/2020 <br/>: 01/07/2022</th>
...
<tr style="font-size:12px; color:#000000;">
	...
	<tr style="font-size:12px; color:#000000;">
	    ...
	    <th rowspan="2">Volume<br/> 280 &plusmn 50 mL<br/> (230 - 330 mL)</th>
...
<table border=1 cellpadding=4  style="border-collapse:collapse;">
        <tr style="font-size:12px; color:#000000;">
	    <th colspan="2" align="left">Catatan : *Standar Kelulusan* <br/>Residual Leukosit/Unit = < 5 x 10<sup>6</sup></th>
	</tr><br>
</table>
