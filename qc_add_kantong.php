...
if((isset($_POST[submit])) and ($_POST[berat_ku]!=="")){
	$sql="INSERT INTO `master_kantong_qc`
          (`merk`, `jenis`, `vol`, `berat_ku`, `berat_s1`, `berat_s2`, `berat_s3`, `berat_s4`, `berat_s5`, `berat_s6`, `berat_s7`,`lama_buka`,`antkogulan`)
          VALUES
          ('$_POST[merk]','$_POST[jenis]', '$_POST[vol]','$_POST[berat_ku]','$_POST[berat_s1]','$_POST[berat_s2]','$_POST[berat_s3]','$_POST[berat_s4]',
          '$_POST[berat_s5]','$_POST[berat_s6]','$_POST[berat_s7]','$_POST[lama_buka]','$_POST[antkogulan]')";
	...
	if ($sqladd){
		...
		echo "<meta http-equiv=\"refresh\" content=\"1; URL=pmiqc.php?module=master_kantong\">";
	} else {
		echo "<br><br>Update Sukses!</b><br>";
		echo "<meta http-equiv=\"refresh\" content=\"1; URL=pmiqc.php?module=master_kantong\">";
	}
}else{?>
    <font size="4" color="red" face="Trebuchet MS"><b>TAMBAH MASTER KANTONG</b></font>
	...
	<table class="form" cellspacing="1" cellpadding="0" border="1">
        <tr>
		    ...
		    if ($_POST[merk]=='FRESENIUS KABI') $select9='selected';
		    if ($_POST[merk]=='HAEMONETICS') $select10='selected';		    
		    if ($_POST[merk]=='TRIMA ACCELL') $select11='selected';
		    if ($_POST[merk]=='TERUMO TRIMA') $select12='selected';
		    ...
		    <option value="FRESENIUS KABI" <?=$select9?>>FRESENIUS KABI</option>
		    <option value="Produk DEMO" <?=$select8?>>Produk DEMO</option>
		    <option value="HAEMONETICS" <?=$select10?>>HAEMONETICS</option>
		    <option value="TRIMA ACCELL" <?=$select11?>>TRIMA ACCELL</option>
		    <option value="TERUMO TRIMA" <?=$select12?>>TERUMO TRIMA</option>
                </select>
            </td>
        </tr>
        <tr>
...
<tr>
        ...
        <tr>
            ...
            <td class="input"><input name="lama_buka" type="text" size="10"></td>
        </tr>
	 <tr>
            <td style="font-size: 15px">Anti Kogulan</td>
            <td class="input"><input name="antkogulan" type="text" size="10"></td>
        </tr>
		<tr>
    ...
    <a href="pmiqc.php?module=master_kantong"class="swn_button_blue">Kembali</a>
    </form>
