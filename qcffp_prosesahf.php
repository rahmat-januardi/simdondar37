...
`i-hiv`,`i-syp`,`qcuser`,`qcchecker`,`qcpengesah`,`qc_status`,`hsl_periksa_fisik`,`hasil_periksahem`,`v_hemolisis`,`v_lipemik`,`v_penggumpalan`,`v_warna`,`v_tdk`,`leukosit`,`trombosit`,`vaktorviii`)
...
'$v_qcpengesah','$v_rsatus_ket','$v_rfisik_ket','$v_rhematologi','$vi_hemolisis','$vi_lipemik','$vi_penggumpalan','$vi_warna','$vi_tdk','$v_rleukosit1','$v_rtrombosit1','$v_rfaktor8')";
	    $qact=mysql_query($sql);
    ...
    if ($mode_kembali==1){
        echo "<meta http-equiv='refresh' content='2;url=pmiqc.php?module=menu_ffp'>";
    } else{
        echo "<meta http-equiv='refresh' content='2;url=pmiqc.php?module=menu_ffp'>";
    }
...
<tr>
        ...
        <td class="input"><input name="volume" type="text" size="2" readonly="readonly" style="background-color:#BDB76B";> ml</td>
		   ...
		   <tr><td style="" colspan="2">Hasil Perhitungan Hemolisis</td> <td><input onchange="hitung()" type="text" size="2" name="hemolisis" readonly="readonly">%
                   <input type="text" size="25" placeholder="Isi Disini Bila Dilakukan Secara Manual" name="hemolisis1">%</td></tr>-->
...
<table cellpadding=4 cellspacing=4 width="100%" style="border: 0px; border-color: #ffffff;">
		    ...
		    <!--<input type="text" size="25" placeholder="Isi Disini Bila Dilakukan Secara Manual" name="leukosit2">g/unit--></td>
		    </tr>
		    ...
		    <!--<input type="text" size="25" placeholder="Isi Disini Bila Dilakukan Secara Manual" name="trombosit2">g/unit--></td>
		    </tr>

		    <tr><td style="background-color: mistyrose" colspan="2">Faktor VIII</td> <td><input type="text" onchange="hitung()" placeholder="Isi Angka" name="faktor8" required="" size="5"></td></tr>
...
<br/><br/>
<font size="4" color=00008B><br>Hasil Pemeriksaan</font>
<table cellpadding=4 cellspacing=4 width="100%" style="border: 0px; border-color: #ffffff;">
            <tr>
                    <td valign="top">
                    <table width="100%" cellpadding="5" cellspacing="5">
