...
<form name="prolis" method=post>
    <font size="4" color=00008B>QC Produk TC Tromboferesis ==Masukkan No.Kantong==<br> </font><br/>
...
if (isset($_POST[cari])) {
    ...
    if (($stokkantong['Status']=='2') and ($stokkantong['sah']=='1') and ($stokkantong['statQC']=='0') and ($stokkantong['statKonfirmasi']=='1') and ($stokkantong['produk']=='TC Tromboferesis')){
        $URL="pmiqc.php?module=qctc_prosestrom&nokantong=$nkt&mode=2";
        header("Location: $URL");
    }else{
