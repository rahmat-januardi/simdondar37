...
<body>
    ...
    <p align="center" class="COOPER">
        <font size="5"><u>DOKUMEN KEBIJAKAN<br /><?php echo $data['nama1']; ?></u></font>
    </p>
    <form method="post" action="edit_kebijakan.php" enctype="multipart/form-data">
        ...
        <table align="center" border="1" cellpadding="10" cellspacing="1" bgcolor="#FFFFFF">
    	    ...
    	    <option>5</option>-->
                        ...
                        <tr>
                            ...
                            <td>
                                <div align="left"><strong>
                                        <input type="text" name="kontrol" style="background:yellow;" readonly="readonly"
                                            value="<?php echo $data['kontrol']; ?>" size="30" />
                                    </strong></div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <div align="right"><strong>Periode Review (bulan)</strong></div>
                            </td>
                            <td><strong>:</strong></td>
                            <td>
                                <div align="left"><strong>
                        ...
                        <tr>
                            <td>
                                <div align="right"><strong>Tanggal Disetujui</strong></div>
                            </td>
                            <td><strong>:</strong></td>
                            <td>
                                <div align="left"><strong>
    ...
    <br />
    <p align="center"><b> Riwayat Perubahan Kebijakan</b></p>
    <table align="center">
        <tr>
