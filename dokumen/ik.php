...
if (isset($_GET['export_excel'])) {
    ...
    header('Content-Disposition: attachment; filename="dokumen_instruksi_kerja.xls"');
    ...
    $exportQuery = mysql_query("select * from ik where aktif='0' order by kontrol2");
    $today = date('Y-m-d');
    ...
    echo '<h2>Dokumen Instruksi Kerja (L3)</h2>';
    echo '<table>';
    echo '<tr>'
...
<body>
    ...
    <br><br>
    <a href="rekap_musnah_ik.php"><button class="button1">Daftar Penarikan Dokumen</button></a>
    ...
    <table>
        ...
        <tbody id="myTable">
            ...
            <tr>
                ...
                <td><a href="keluar_ik.php?detail=<?php echo $data['kontrol2']; ?>"><img src="images/clip.png"
                            width="30" height="30"></img>
                    </a></td>
                <td><a href="detail_ik.php?detail=<?php echo $data['kontrol2']; ?>"><img src="images/revisi.png"
                            width="30" height="30"></img></a></td>
                <td><a href="musnah_ik.php?detail=<?php echo $data['nomor']; ?>"><img src="images/musnah.png" width="30"
                            height="30"></img></a></td>
            </tr>
            <?php
            }
