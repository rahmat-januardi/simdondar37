...
$sql = "select * from pendukung where kontrol2='$detail' and aktif='0'";
...
<body>
    ...
    <p align="center" class="COOPER">
        <font size="5"><u>FORM PENGELUARAN DOKUMEN PENDUKUNG<br /><?php echo $data['nama1']; ?></u></font>
    </p>

    <p align="center"><?php echo $data['nama']; ?><?php echo $data['kontrol2']; ?></p>
