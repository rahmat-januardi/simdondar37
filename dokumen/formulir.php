    ...
    <table>
        <thead>
            <tr>
                ...
                <th rowspan="2" style="display:none">Tanggal Disahkan</th>
        ...
        <tbody id="myTable">
            ...
            <tr>
                ...
                <td><a href="keluar_formulir.php?detail=<?php echo $data['kontrol2']; ?>&no=<?= $data['nomor']; ?>"><img
                            src="images/clip.png" width="30" height="30"></img>
                    </a></td>
