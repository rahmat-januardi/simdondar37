...
<body>
<br />
<p align="center" class="COOPER"><font size="5"><u>DOKUMEN KEBIJAKAN<br /><?php echo $data['nama1']; ?></u></font></p>
...
<tr>
    ...
    <tr>
        ...
        <td><strong>:</strong></td>
        <td><div align="left"><strong>
          <input type="text" name="kontrol" style="background:yellow;" readonly="readonly" value="<?php echo $data['kontrol']; ?>" size="30" />
        </strong></div></td>
    </tr>
    <tr>
    	<td><div align="right"><strong>Periode Review (bulan)</strong></div></td>
        <td><strong>:</strong></td>
        <td><div align="left"><strong>
