...
if (isset($_GET['export_excel'])) {
    ...
    header('Content-Disposition: attachment; filename="dokumen_ik_ditarik.xls"');
    ...
    $exportQuery = mysql_query("select * from ik where aktif='1' order by kontrol2");
    $today = date('Y-m-d');
    ...
    echo '<h2>Daftar Dokumen IK Yang Telah Ditarik</h2>';
    echo '<table>';
...
<body>
    ...
    <br><br>
    <p align="center"><b> Daftar Dokumen IK Yang Telah Ditarik</b></p>
    <table>
        <thead>
            <tr>
                <th rowspan="2">No</th>
