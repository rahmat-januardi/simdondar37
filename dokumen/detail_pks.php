...
<body>
    ...
    <p align="center" class="COOPER">
        <font size="5"><u>STANDAR PROSEDUR OPERASIONAL<br /><?php echo $data['nama1']; ?></u></font>
    </p>
                    ...
                    <table align="center">
                      ...
                      ?>
                        ...
                        <tr>
                            ...
                            <td><strong>:</strong></td>
                            <td>
                                <div align="left"><strong><input type="text" name="nama_ubah" size="50"
                                            value="<?php echo $data['nama1']; ?>" style="display:none" />
