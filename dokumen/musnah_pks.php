...
$detail = $_GET['detail'];
$sql = "select * from pks where nomor='$detail'";
...
<body>
    ...
    <p align="center" class="COOPER">
        <font size="5"><u>FORM PENARIKAN DOKUMEN SPO<br /><?php echo $data['nama1']; ?></u></font>
    </p>
                ...
                <td valign="top">
                    <table align="center">
                        <tr>
                            ...
                            <td>
                                <div align="left"><strong>
                                    ...
                                    </strong></div> <strong style="display:none"><text>
                                        <div align="left">
                        ...
                        <tr>
                            ...
                            <td>
                                <div align="left"><strong>
                                        <input type="date" name="tgl_musnah1" required=""
