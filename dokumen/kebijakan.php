...
if (isset($_GET['export_excel'])) {
    ...
    header('Content-Disposition: attachment; filename="dokumen_kebijakan.xls"');
    ...
    $exportQuery = mysql_query("select * from kebijakan where aktif='0' order by right(kontrol,3)");
    ...
    echo '<h2>Dokumen Kebijakan (L1)</h2>';
    echo '<table>';
    echo '<tr>'
    ...
    while ($exportData = mysql_fetch_array($exportQuery)) {
        ...
        echo '<tr>'
            ...
            . '<td>' . export_excel_escape($exportData['kontrol']) . '</td>'
...
<body>
    ...
    <a href="rekap_musnah_kebijakan.php"><button class="button1">Daftar Penarikan Dokumen</button></a>
    ...
    <table>
        ...
        <tbody id="myTable">
            ...
            <tr>
                ...
                <td><a href="keluar_kebijakan.php?detail=<?php echo $data['kontrol']; ?>"><img src="images/clip.png"
                            width="30" height="30"></img>
                    </a></td>
                <td><a href="detail_kebijakan.php?detail=<?php echo $data['kontrol']; ?>"><img src="images/revisi.png"
                            width="30" height="30"></img></a></td>
                <td><a href="musnah_kebijakan.php?detail=<?php echo $data['nomor']; ?>"><img src="images/musnah.png"
