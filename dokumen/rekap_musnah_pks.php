...
if (isset($_GET['export_excel'])) {
    ...
    header('Content-Disposition: attachment; filename="dokumen_spo_ditarik.xls"');
    ...
    $exportQuery = mysql_query("select * from pks where aktif='1' order by kontrol2");
    $today = date('Y-m-d');
    ...
    echo '<h2>Daftar Dokumen SPO Yang Telah Ditarik</h2>';
    echo '<table>';
    echo '<tr><th>No</th><th>Bidang</th><th>Judul Dokumen</th>'
        . '<th>Identitas Dokumen Sebelumnya</th><th>Tingkat Dokumen</th>'
        . '<th>No. Kontrol Dokumen</th><th>Periode Review (bln)</th><th>No. Versi</th>'
        . '<th>Tanggal Disetujui</th><th>Tanggal Berlaku</th><th>Tanggal Kaji Ulang</th>'
...
<body>
    ...
    <br><br>
    <p align="center"><b> Daftar Dokumen SPO Yang Telah Ditarik</b></p>
    <table>
        <thead>
            <tr>
                <th rowspan="2">No</th>
