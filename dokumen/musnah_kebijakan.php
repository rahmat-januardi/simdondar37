...
<body>
    ...
    <p align="center" class="COOPER">
        <font size="5"><u>FORM PEMUSNAHAN DOKUMEN KEBIJAKAN<br /><?php echo $data['nama1']; ?></u></font>
    </p>
    <?php
  $sql = "select kebijakan.terkait as nama, pks.kontrol as kontrol, pks.kontrol as kontrol2, pks.kontrol3 as kontrol3  from pks,kebijakan where pks.nama1=kebijakan.terkait and kebijakan.nomor='$detail'";
  $proses = mysql_query($sql);
  $data = mysql_fetch_array($proses);
  ?>
    <p align="center">
        <?php echo $data['nama']; ?><?php echo $data['kontrol']; ?><?php echo $data['kontrol']; ?><?php echo $data['kontrol3']; ?>
    </p>
    <?php
  $sql = "select * from kebijakan where kontrol='$detail'";
  $proses = mysql_query($sql);
  $data = mysql_fetch_array($proses);
  ?>
    <form method="post" action="musnah_data_kebijakan.php" enctype="multipart/form-data">
            ...
            <tr>
                <td valign="top">
                    <table align="center">
                            ...
                            <td>
                                <div align="left"><strong>
                                        <input type="text" style="background:yellow;" readonly="readonly"
                                            name="kontrol2" size="20" value="<?php echo $data['kontrol']; ?>" />
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                <div align="right"><strong>Tanggal Pemusnahan</strong></div>
                            </td>
                            <td><strong>:</strong></td>
                            <td>
                                <div align="left"><strong>
                                        <input type="text" name="tgl_musnah1" required=""
                        ...
                        <tr>
                            <td>
                                <div align="right"><strong>Petugas Yang Memusnahkan</strong></div>
                            </td>
                            <td><strong>:</strong></td>
                            <td>
                                <div align="left"><strong>
