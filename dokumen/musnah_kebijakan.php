...
$sql = "select * from kebijakan where nomor='$detail'";
...
<body>
    ...
    <p align="center" class="COOPER">
        <font size="5"><u>FORM PENARIKAN DOKUMEN KEBIJAKAN<br /><?php echo $data['nama1']; ?></u></font>
    </p>
            ...
            <tr>
                <td valign="top">
                    <table align="center">
                        ...
                        <tr>
                            <td>
                                <div align="right"><strong>Tanggal Penarikan</strong></div>
                            </td>
                            <td><strong>:</strong></td>
                            <td>
                                <div align="left"><strong>
                        ...
                        <tr>
                            <td>
                                <div align="right"><strong>Petugas Yang Menarik</strong></div>
                            </td>
                            <td><strong>:</strong></td>
                            <td>
                                <div align="left"><strong>
