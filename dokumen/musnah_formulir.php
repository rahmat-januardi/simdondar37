...
$sql = "select * from formulir where nomor='$detail'";
...
<body>
    ...
    <p align="center" class="COOPER">
        <font size="5"><u>FORM PENARIKAN DOKUMEN FORMULIR<br /><?php echo $data['nama1']; ?></u></font>
    </p>

    <form method="post" action="musnah_data_formulir.php" enctype="multipart/form-data">
