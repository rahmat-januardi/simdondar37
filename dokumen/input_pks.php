...
<body>
    ...
    <p align="center" class="COOPER">
        <font size="5"><u>INPUT SPO BARU</u></font>
    </p>
        ...
        <table align="center" border="1" cellpadding="10" cellspacing="1" bgcolor="#FFFFFF">
    	    ...
    	    <option>5</option>-->
                        ...
                        <tr>
                            <td>
                                <div align="left"><strong>
                                        <input type="text" id="ptpmi1" name="ptpmi1" value="PSU" readonly="readonly"
                                            size="7" disabled />
                                        ...
                                        <input type="text" id="ptpmi3" name="ptpmi3" value="-L2-" readonly="readonly"
                                            size="5" disabled />
