...
<body>
    ...
    <p align="center" class="COOPER">
        <font size="5"><u>STANDAR PROSEDUR OPERASIONAL</u><br /><?php echo $data['nama1']; ?></font><br />
    ...
    <div class="columns">
        <ul class="price">
            ...
            <table align="center">
                ...
                <?php
                $donor = "select * from ik where terkait='$detail' and aktif='0'";
                ...
                <tr>
                    <td><?php echo $nourut; ?><br />
                        <a href="detail_ik.php?detail=<?php echo $data['kontrol2']; ?>"><img
                                src="images/ubah.png"></img></a>&nbsp;&nbsp;<a
                            href="hapus_ik.php?hapus=<?php echo $data['kontrol2']; ?>"><img
                                src="images/hapus.png"></img></a>
                    </td>
            ...
            $data = mysql_fetch_array($proses);
            ?>
            <li class="grey"><a href="input_ik.php?detail=<?php echo $data['nama1']; ?>" class="button">Tambah
                    Dokumen</a></li>
        </ul>
    </div>
    ...
    <div class="columns">
        <ul class="price">
            ...
            <table align="center">
                ...
                <?php
                $donor = "select * from ika where terkait='$detail'  and aktif='0'";
                $proses = mysql_query($donor);
                $nourut = 0;
                while ($data = mysql_fetch_array($proses)) {
                    $nourut++;
                ...
                <tr>
                    <td><?php echo $nourut; ?><br />
                        <a href="detail_ika.php?detail=<?php echo $data['kontrol2']; ?>"><img
                                src="images/ubah.png"></img></a>&nbsp;&nbsp;<a
                            href="hapus_ika.php?hapus=<?php echo $data['kontrol2']; ?>"><img
                                src="images/hapus.png"></img></a>
                    </td>
                    <td><?php echo $data['nama1']; ?></td>
                    <td><?php echo $data['kontrol2']; ?></td>
            ...
            $data = mysql_fetch_array($proses);
            ?>
            <li class="grey"><a href="input_ika.php?detail=<?php echo $data['nama1']; ?>" class="button">Tambah
                    Dokumen</a></li>
        </ul>
    </div>
    ...
    <div class="columns">
        <ul class="price">
            ...
            <table align="center">
                ...
                <?php
                $donor = "select * from formulir where terkait='$detail' and aktif='0'";
                $proses = mysql_query($donor);
                $nourut = 0;
                while ($data = mysql_fetch_array($proses)) {
                    $nourut++;
                ...
                <tr>
                    <td><?php echo $nourut; ?><br />
                        <a href="detail_formulir.php?detail=<?php echo $data['kontrol2']; ?>"><img
                                src="images/ubah.png"></img></a>&nbsp;&nbsp;<a
                            href="hapus_formulir.php?hapus=<?php echo $data['kontrol2']; ?>"><img
                                src="images/hapus.png"></img></a>
                    </td>
                    <td><?php echo $data['nama1']; ?></td>
                    <td><?php echo $data['kontrol2']; ?></td>
            ...
            $data = mysql_fetch_array($proses);
            ?>
            <li class="grey"><a href="input_formulir.php?detail=<?php echo $data['nama1']; ?>" class="button">Tambah
                    Dokumen</a></li>
        </ul>
    </div>
  ...
  <ul class="price">
    ...
    <?php
    $donor = "select * from eksternal where terkait='$detail'  and aktif='0'";
    $proses = mysql_query($donor);
    $nourut = 0;
    while ($data = mysql_fetch_array($proses)) {
        $nourut++;
    ...
    <div class="columns">
        <ul class="price">
            ...
            <table align="center">
                ...
                <?php
                $donor = "select * from pendukung where terkait='$detail' and aktif='0'";
                $proses = mysql_query($donor);
                $nourut = 0;
                while ($data = mysql_fetch_array($proses)) {
                    $nourut++;
                ...
                <tr>
                    <td><?php echo $nourut; ?><br />
                        <a href="detail_pendukung.php?detail=<?php echo $data['kontrol2']; ?>"><img
                                src="images/ubah.png"></img></a>&nbsp;&nbsp;<a
                            href="hapus_pendukung.php?hapus=<?php echo $data['kontrol2']; ?>"><img
                                src="images/hapus.png"></img></a>
                    </td>
                    <td><?php echo $data['nama1']; ?></td>
                    <td><?php echo $data['kontrol2']; ?></td>
            ...
            $data = mysql_fetch_array($proses);
            ?>
            <li class="grey"><a href="input_pendukung.php?detail=<?php echo $data['nama1']; ?>" class="button">Tambah
                    Dokumen</a></li>
        </ul>
    </div>
