...
if (isset($_GET['export_excel'])) {
    ...
    header('Content-Disposition: attachment; filename="dokumen_spo.xls"');
    ...
    $exportQuery = mysql_query("select * from pks where aktif='0' order by kontrol2");
    ...
    while ($exportData = mysql_fetch_array($exportQuery)) {
        ...
        $resultNoKontrol = substr($exportData['kontrol2'], -1, 1) !== "-" ? $exportData['kontrol2'] : substr($exportData['kontrol2'], 0, -1);
        ...
        echo '<tr>'
            ...
            . '<td>' . export_excel_escape($exportData['tingkat']) . '</td>'
            . '<td>' . export_excel_escape($resultNoKontrol) . '</td>'
            . '<td>' . export_excel_escape($exportData['periode']) . '</td>'
            . '<td>' . export_excel_escape($exportData['no_versi']) . '</td>'
...
<body>
    ...
    <a href="rekap_musnah_pks.php"><button class="button1">Daftar Penarikan Dokumen</button></a>
    <a href="?export_excel=1">
        <button class="button" style="background-color: #3e8e41;">
            Export Excel
        </button>
    </a>
    <br><br>
    ...
    <table>
        ...
        <tbody id="myTable">
            ...
            <tr>
                ...
                <td>
                    <div align="left"><a href="detail_pks2.php?detail=<?php echo $data['nama1']; ?>"><button
                                class="button"><?php echo $data['nama1']; ?></button></a></div>
                </td>
                <td>
                ...
                <td>
                    <div align="center"><?php echo $resultNoKontrol; ?></div>
                </td>
                <td>
                ...
                <td><a href="keluar_pks.php?detail=<?php echo $data['kontrol2']; ?>"><img src="images/clip.png"
                            width="30" height="30"></img>
                    </a></td>
                <td><a href="detail_pks.php?detail=<?php echo $data['kontrol2']; ?>"><img src="images/revisi.png"
                            width="30" height="30"></img></a></td>
                <td><a href="musnah_pks.php?detail=<?php echo $data['nomor']; ?>"><img src="images/musnah.png"
                            width="30" height="30"></img></a></td>
