...
$stokkantong = mysql_query("select * from stokkantong where nokantong='$nkt' and (Status='2' or Status='3')  and sah='1'");
...
switch ($kantongke) {
    ...
    case 'A':
        $beratkantongkosong = $masterkantong1['berat_ku'];
        break;
    case 'B':
        $beratkantongkosong = $masterkantong1['berat_s1'];
        break;
    case 'C':
        $beratkantongkosong = $masterkantong1['berat_s2'];
        break;
    case 'D':
        $beratkantongkosong = $masterkantong1['berat_s3'];
        break;
    case 'E':
        $beratkantongkosong = $masterkantong1['berat_s4'];
        break;
    case 'F':
        $beratkantongkosong = $masterkantong1['berat_s5'];
        break;
    case 'G':
        $beratkantongkosong = $masterkantong1['berat_s6'];
        break;
    case 'H':
        $beratkantongkosong = $masterkantong1['berat_s7'];
        break;
    default:
...
$antkogulan = $produk2['antikoagulant'];
...
if ($volumekomponendarah < 0) {
    $volumekomponendarah = "0";
}
$var_volume_kantong = '0';
if ($volumekomponendarah < $vol_min) {
    $var_volume_kantong = '1';
}
if ($volumekomponendarah > $vol_max) {
    $var_volume_kantong = '1';
}
...
if ($donasi['JenisDonor'] == '0') {
    $jenisdonor = 'Donor Sukarela';
} else {
    $jenisdonor = 'Donor Pengganti';
};
if ($donasi['donorbaru'] == '0') {
    $donorbaru = 'Donor Baru';
} else {
    $donorbaru = 'Donor Ulang';
};
if ($donasi['jk'] == '0') {
    ...
    <tr>
        <td valign="top">
            <table width="100%" cellpadding="5" cellspacing="5">
                ...
                <tr>
                    <td style="background-color: mistyrose">Status Kantong</td>
                    <td><?= $posisikantong ?></td>
                </tr>
                <tr>
                    <td style="background-color: mistyrose">Merk</td>
                    <td><?= $merk ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="background-color: mistyrose">Gol Darah & Rhesus</td>
                    <td><?= $goldarah ?> (<?= $rhesusDrh ?>)</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="background-color: mistyrose">Tanggal Aftap</td>
                    <td><?= $tglaftap2 ?></td>
                </tr>
                <tr>
                    <td style="background-color: mistyrose">Tanggal Kedaluwarsa Produk</td>
                    <td><?= $tglkadaluwarsa2 ?></td>
                </tr>
