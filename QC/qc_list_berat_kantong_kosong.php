...
if (isset($_GET['op']) && $_GET['op'] == 'hapus' && isset($_GET['id'])) {
	$id = intval($_GET['id']);
	$deleteQuery = "DELETE FROM `master_kantong_qc` WHERE `id` = $id";
	mysqli_query($dbi, $deleteQuery);

	//=======Audit Trial====================================================================================

	$log_mdl = $level;
	$log_aksi = 'Hapus Master Berat Kantong Kosong dengan Merk ' . $_GET['merk'] . ' dan Jenis ' . $_GET['jenis'] . ' dan Volume ' . $_GET['vol'];
...
<body>
            ...
            <table id="kantongTable" class="table table-striped table-bordered custom-table" style="width:100%;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <!-- Tombol Ubah -->
                            <button class="btn btn-edit btn-sm edit-btn" data-id="<?php echo $tmp['id']; ?>"
                                data-bs-toggle="modal" data-bs-target="#editModal">
                                <i class="fa fa-edit"></i> Ubah
                            </button>

                            <!-- Tombol Hapus -->
                            <a href="<?= $lokasi ?>&op=hapus&id=<?php echo $tmp['id']; ?>&merk=<?php echo urlencode($tmp['merk']); ?>&jenis=<?php echo urlencode($tmp['jeniskantong']); ?>&vol=<?php echo urlencode($tmp['vol']); ?>"
                                onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')"
                                class="btn btn-hapus btn-sm" title="Hapus">
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        document.querySelectorAll(".klik-merk").forEach(el => {
            el.addEventListener("click", function() {
                ...
                fetch("QC/detailMasterKantong.php?id=" + encodeURIComponent(id))
                    .then(res => res.text())
                    .then(html => {
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        document.querySelectorAll(".edit-btn").forEach(button => {
            button.addEventListener("click", function() {
                ...
                fetch(`QC/ambilBeratKantong.php?id=${id}`)
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            document.getElementById("editBeratKU").value = data.data
                                .berat_ku;
                            document.getElementById("editAntikoagulant").value = data.data
                                .antikoagulant;
                            ...
                            document.getElementById("editTexture").value = data.data
                                .texture;
                            document.getElementById("editAnticoagulantName").value = data
                                .data.anticoagulant_name;
                            ...
                            document.getElementById("editLicenseby").value = data.data
                                .licenseby;
                            document.getElementById("editDimensiTinggi").value = data.data
                                .dimensi_tinggi;
                            document.getElementById("editDimensiLebar").value = data.data
                                .dimensi_lebar;
                            document.getElementById("editPanjangSelang").value = data.data
                                .panjang_selang;
                            document.getElementById("editBeratKeseluruhan").value = data
                                .data.berat_keseluruhan;
                            document.getElementById("editEvUtdptanggal").value = data.data
                                .ev_utdptanggal;
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        form.addEventListener("submit", function(event) {
            ...
            fetch("QC/aksiMasterBeratKantong.php", {
                    method: "POST",
                    body: formData
                })
                .then(response => {
