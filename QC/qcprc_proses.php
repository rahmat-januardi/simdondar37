...
<body>
    ...
    if (isset($_POST['Button'])) {
		...
		`anaerob`	    ='$v_anaerob'
            ...
            $sql = "INSERT INTO `qc`(`notrans`, `qctgl`, `nokantong`, `jenis`, `merk`, `gol_darah`, `RhesusDrh`, `produk`, `tglaftap`, `tglpengolahan`, `kadaluwarsa`, `tgledkantong`, `berat_isi`, `berat_kosong`, `berat_jenis`, `volume`, `volhem`, `kadhb`, `hct`, `plasma`, `ttlhb`, `hemolisis`, `hematokrit`, `hemoglobin`, `aerob`, `anaerob`, `kebocoran`, `visual`, `i-hbs`, `i-hcv`, `i-hiv`, `i-syp`, `qcuser`, `qcchecker`, `qcpengesah`, `qc_status`, `hsl_periksa_fisik`, `hasil_periksahem`, `up_data`)
          VALUES ('$v_rnotrans','$v_rtgl','$nkt','$v_jenis','$v_merk','$v_goldarah','$v_rhesus','$v_rproduk','$v_tglaftap', '$v_tglpengolahan', '$v_kadaluwarsa',
'$v_tgledkantong','$v_beratisi','$v_beratkosong','$v_beratjenis','$v_volume', '$v_volhem', '$v_kadhb', '$v_hct','$v_plasma','$v_ttlhb','$v_hemolisis', '$v_hcthem', '$v_hemoglobin','$v_aerob','$v_anaerob', '$v_kebocoran', '$v_rvisual', '$v_ihbs', '$v_ihcv','$v_ihiv','$v_isyp','$v_qcuser','$v_qcchecker',
    ...
    <form name="form_prolis" align="left" method="post" action="<? echo $PHPSELF ?>">
        ...
        <script>
            function hitung() {
                ...
                document.form_prolis.volume.value = Math.round(rumus2);
                var tVolhem1 = rumus2 / 100;
                        ...
                        <table width="100%" cellpadding="5" cellspacing="5">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input onchange="hitung()" name="beratkosong" value="<?= $beratkantongkosong ?>"
                                        type="text" size="5" placeholder="Isi Angka" required=""
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input onchange="hitung()" name="beratjenis" type="text" size="5"
                                        value="<?= $beratjenis ?>" placeholder="Isi Angka" required=""
                                        readonly="readonly">gram
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="input"><input name="volume" type="text" size="2" readonly="readonly"
                ...
                <tr>
                    <td valign="top">
                        <table width="100%" cellpadding="5" cellspacing="5">
                            <tr>
                                <td style="background-color: mistyrose" colspan="2">HCT</td>
                                <td><input type="text" size="5" placeholder="Isi Angka" name="hcthem" required></td>
                            </tr>
                            <tr>
