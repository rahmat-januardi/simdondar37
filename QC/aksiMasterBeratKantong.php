...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	*/
        ...
        $stmt = $dbi->prepare("SELECT COUNT(*) as total FROM master_kantong_qc WHERE merk = ? AND jenis = ? AND vol = ?");
        ...
        $query = "INSERT INTO master_kantong_qc (
        ...
        $query = "UPDATE master_kantong_qc SET 
            merk = ?, 
            jenis = ?, 
            vol = ?, 
            berat_ku = ?, 
