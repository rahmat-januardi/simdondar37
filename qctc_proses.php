                    ...
                    <td valign="top">
                        <table width="100%" cellpadding="5" cellspacing="5">
                            ...
                            <tr>
                                ...
                                <td class="input"><input name="volume" type="text" size="3" readonly="readonly"
                            ...
                            <tr>
                                ...
                                <td class="input"><input type="text" name="ph" type="text" size="5"
                                        placeholder="Isi Angka"></td>
                            </tr>

                            <tr>
                                <td style="" colspan="2">Swirling</td>
                                <td>
		   ...
		   <tr><td style="" colspan="2">Hasil Perhitungan Hemolisis</td> <td><input onchange="hitung()" type="text" size="2" name="hemolisis" readonly="readonly">%
                   <input type="text" size="35" placeholder="Isi Disini Bila Dilakukan Secara Manual" name="hemolisis1">%</td></tr>-->
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="checkbox" name="vi_hemolisis" id="vi_hemolisis" />Hemolisis<div
                                        class="control_indicator"></div><br />
                                    <input type="checkbox" name="vi_lipemik" id="vi_lipemik" />Lipemik<div
                                        class="control_indicator"></div><br />
                                    <input type="checkbox" name="vi_penggumpalan" id="vi_penggumpalan" />Penggumpalan
                                    <div class="control_indicator"></div><br />
                                    <input type="checkbox" name="vi_warna" id="vi_warna" />Perubahan Warna<div
                                        class="control_indicator"></div><br />
                                    <input type="checkbox" name="vi_tdk" id="vi_tdk" />Tidak Ada<div
		    ...
		    <tr><td style="" colspan="2">Hemoglobin</td> <td><input type="text" onchange="hitung()" readonly="readonly" name="hemoglobin" size="5">g/unit</td></tr>-->
                            ...
                            <tr>
                                <td style="background-color: mistyrose" colspan="2">Kadar WBC</td>
                                <td><input type="text" onchange="hitung()" placeholder="Isi Angka" name="wbc"
                                        required="" size="5"> g/unit</td>
                            </tr>
                            <tr>
                                <td style="" colspan="2">Leukosit</td>
                                <td><input type="text" name="leukosit" size="5" style="background-color:yellow" ;>
                                    g/unit
                                    <!--<input type="text" size="35" placeholder="Isi Disini Bila Dilakukan Secara Manual" name="leukosit2">g/unit-->
                                </td>
                            </tr>

                            <tr>
                                <td style="background-color: mistyrose" colspan="2">Kadar Platelet</td>
                                <td><input type="text" onchange="hitung()" placeholder="Isi Angka" name="platelet"
                                        required="" size="5"> g/unit</td>
                            </tr>
                            <tr>
                                <td style="" colspan="2">Trombosit</td>
                                <td><input type="text" name="trombosit" size="5" style="background-color:yellow" ;>
                                    g/unit
                                    <!--<input type="text" size="35" placeholder="Isi Disini Bila Dilakukan Secara Manual" name="trombosit2">g/unit-->
                                </td>
                            </tr>
                ...
                <tr>
                    <td valign="top">
                        <table width="100%" cellpadding="5" cellspacing="5">
                            ...
                            <tr>
                                <td style="background-color: mistyrose" colspan="2">Tanggal Pemeriksaan</td>
                                <td>
