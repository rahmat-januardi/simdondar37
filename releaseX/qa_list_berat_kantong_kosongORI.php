...
<body>
	...
	while($tmp=mysql_fetch_assoc($qraw)){
		...
		<tr style="font-size:13px; color:#000000; font-family:Verdana;" onMouseOver="this.className='highlight'" onMouseOut="this.className='normal'">
			...
			<td nowrap>
				<a href="pmi<?=$lvl0?>.php?module=edit_beratkantong&id=<?=$tmp['id']?>" alt="Mengubah berat kantong"  >Ubah</a>
		</tr>
	<?}
	if ($no==0){?>
        <tr style="font-size:13px; color:#000000; font-family:Verdana;" onMouseOver="this.className='highlight'" onMouseOut="this.className='normal'">
	...
	<!--a href="pmi<?=$lvl0?>.php?module=input_qa"class="swn_button_blue">Kembali</a-->
    <a href="pmi<?=$lvl0?>.php?module=kantong"class="swn_button_blue">Tambah</a>
    <!--a href="pmi<?=$lvl0?>.php?module=cetak_list_kantong"class="swn_button_blue">Cetak</a-->
	<?
?>
</body>
</html>
