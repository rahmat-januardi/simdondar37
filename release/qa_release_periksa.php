...
<table cellpadding=3 cellspacing=3 width="100%">
    ...
    while ($imltd = mysql_fetch_assoc($sq_elisa)) {
        $no++;
        if (($imltd[Hasil] == "Reaktif") or ($imltd[Hasil] == "Invalid")) {
            $var_imltd = '1';
        }
    ...
    <tr style="font-size:13px; color:#000000; font-family:Verdana;" onMouseOver="this.className='highlight';"
        ...
        <td class=input><?= $imltd[insert_on] ?></td>
        <td class=input><?= $imltd[Parameter] ?></td>
        <td class=input><?= $imltd[OD] ?></td>
        <? if ($imltd[Hasil] == "Non Reaktif") { ?>
        <td align="left">
...
<table class="list" border=1 cellpadding="2" cellspacing="2" width="100%" style="border-collapse:collapse">
    ...
    <tr style="font-size:12px; color:#000000; font-family:Verdana;" onMouseOver="this.className='highlight'"
        ...
        <td align="center"><?= $a_dtransaksipermintaan[goldarah_asal] ?>(<?= $a_dtransaksipermintaan[rhesus_asal] ?>)
        </td>
