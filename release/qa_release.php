...
<body>
    ...
    if (isset($_POST['Button'])) {
        ...
        switch ($v_rstatus) {
            case '0':
                ...
                break;
            case '1':
                $v_rsatus_ket = 'TIDAK LULUS';
                $v_statusktg = '2';
                break;
            case '2':
                $v_rsatus_ket = 'LULUS (CATATAN)';
                $v_statusktg = '3';
                break;
        }
                ...
                <tr>
                    <td valign="top">
                        <table width="100%" cellpadding="1" cellspacing="1">
                            <tr>
                                <td valign="top">Identitas dan pemakaian kantong darah sesuai spesifikasi
                                <td>
                                    <input type="radio" required="" id="spek_kantong1" name="spek_kantong" value="1"
                                        checked>
                            ...
                            <tr>
                                <td valign="top">Seleksi donor memenuhi kriteria</td>
                                <td>
                            ...
                            <tr>
                                <td valign="top">Waktu pengambilan terpenuhi</td>
                                <td>
                                    <input type="radio" required="" id="waktu_aftap1" name="waktu_aftap" value="1"
                                        checked>
                            ...
                            <tr>
                                <td valign="top">Waktu selesai pengolahan terpenuhi</td>
                                <td>
                                    <input type="radio" required="" id="waktu_komponen1" name="waktu_komponen" value="1"
                                        checked>
                                    <label for="waktu_komponen1">Ya</label>
                                    <input type="radio" required="" id="waktu_komponen2" name="waktu_komponen"
                                        value="0">
                            ...
                            <tr>
                                <td valign="top">Pemeriksaan donasi sebelumnya terpenuhi (bila ada)</td>
                                <td>
                                    <input type="radio" required="" id="jejak_imltd1" name="jejak_imltd" value="1"
                                        checked>
                            ...
                            <tr>
                                <td valign="top">Hasil pemeriksaan memenuhi spesifikasi</td>
                                <td>
                            ...
                            <tr>
                                <td valign="top">Tidak ada tanda-tanda visual kebocoran kantong</td>
                                <td>
                            ...
                            <tr>
                                <td valign="top">Kode unik sesuai dengan spesifikasi</td>
                                <td>
                            ...
                            <tr>
                                <td valign="top">Selang kantong sesuai dengan spesifikasi</td>
                                <td>
                            ...
                            <tr>
                                <td valign="top">Tidak ada Hemolysis</td>
                                <td>
                            ...
                            <tr>
                                <td valign="top">Tidak Lipemik</td>
                                <td>
                            ...
                            <tr>
                                <td valign="top">Tidak Ikterik</td>
                                <td>
                            ...
                            <tr>
                                <td valign="top">Plasma tidak Kehijauan</td>
                                <td>
                            ...
                            <tr>
                                <td valign="top">Tidak ada bekuan pada Sel Darah Merah</td>
                                <td>
                            ...
                            <tr>
                                <td valign="top">Volume produk sesuai spesifikasi</td>
                                <td>
                    ...
                    <td valign="top">
                        <table width="100%" cellpadding="1" cellspacing="1">
                            <tr>
                                <td style="background-color: mistyrose" colspan="2">Nomor Kantong</td>
                                <td><?= $nkt ?></td>
                            </tr>
                            <tr>
                                <?php
                 ...
                 LIMIT 1";
                                ...
                                <td><input type="text" name="noselang"
                                        value="<?php echo htmlspecialchars($no_selang); ?>" size="25"
                                        style="font-family:monospace; font-size:16px;"
                                        placeholder="Masukkan nomor selang"></td>
                            </tr>
                            <tr>
                                <td style="background-color: mistyrose" colspan="2">Status kantong</td>
                                <td><?= $posisikantong . ' - ' . $statuskantong ?> </td>
                            </tr>
                            <tr>
                                <td style="background-color: mistyrose" colspan="2">Nama Produk</td>
                                <td><?= $jeniskomponen . ' - ' . $namakomponen ?></td>
                            </tr>
                            <input type='hidden' name='nama_produk' value='<?= $jeniskomponen ?>'>
                            <tr>
                                <td style="background-color: mistyrose" colspan="2">Gol Darah</td>
                                <td><?= $golongandarah_donasi ?>(<?= $rhesus_donasi ?>)</td>
                            </tr>
                            <tr>
                                <td style="background-color: mistyrose" colspan="2">Tanggal ED Produk</td>
                                <td><?= $tgledkomponen ?></td>
                            </tr>
                            <tr>
                                <td style="background-color: mistyrose" colspan="2">Berat Kantong Kosong</td>
                                <td><?= $beratkantongkosong ?> gram</td>
                            </tr>
                            <tr>
                                <td style="background-color: mistyrose" colspan="2">Berat jenis komponen</td>
                                <td><?= $beratjenis ?></td>
                            </tr>
                            <tr>
                                <td style="background-color: mistyrose" rowspan="4">Hasil<br>penimbangan<br>produk</td>
                            </tr>
                            <tr>
                                <td style="background-color: mistyrose">Tanggal</td>
                                <td><?= $tgltimbang ?></td>
                            </tr>
                            <tr>
                                <td style="background-color: mistyrose">Petugas</td>
                                <td><?= $namapetugastimbang . ' (' . $usertimbang . ') ' ?></td>
                            </tr>

                            <?php
                            if (!function_exists('angka_nol')) {
                                function angka_nol($nilai, $default)
                                {
                            ...
                            if (!function_exists('hitung_volume_komponen')) {
                                function hitung_volume_komponen($berat, $beratkantongkosong, $antikoagulant, $beratjenis, $jeniskomponen)
                                {
                                    $berat = angka_nol($berat, 0);
                                    $beratkantongkosong = angka_nol($beratkantongkosong, 0);
                                    $antikoagulant = angka_nol($antikoagulant, 0);
                                    $beratjenis = angka_nol($beratjenis, 1);
                                    ...
                                    if ($jeniskomponen == "WB") {
                                        $ml = ($berat - $antikoagulant - $beratkantongkosong) / $beratjenis;
                                    } else {
                                        $ml = ($berat - $beratkantongkosong) / $beratjenis;
                                    }
                            ...
                            $berattimbang = angka_nol($berattimbang, 0);
                            $antikoagulant = angka_nol($antikoagulant, 0);
                            $beratjenis = angka_nol($beratjenis, 1);
                            $beratkantongkosong = angka_nol($beratkantongkosong, 0);

                            $ml = hitung_volume_komponen($berattimbang, $beratkantongkosong, $antikoagulant, $beratjenis, $jeniskomponen);
                            ?>
                            <tr>
                                <td style="background-color: mistyrose">Berat</td>
                                <td>
                                    <input required name="berat" id="berat" type="text" size="7"
                                        style="font-family:monospace;" value="<?php echo $berattimbang; ?>"
                                        onkeyup="hitungVolume()" onchange="hitungVolume()" oninput="hitungVolume()">
                                    gram
                                </td>
                            </tr>

                            <tr>
                                <td style="background-color: mistyrose" colspan="2">Volume standar</td>
                                <td><?php echo $vol_min . ' - ' . $vol_max; ?> ml</td>
                            </tr>

                            <tr>
                                <td style="background-color: mistyrose" colspan="2">Volume komponen darah</td>
                                <td>
                                    <input required type="text" name="vol_akhir" id="vol_akhir" size="10"
                                        style="font-family:monospace;" value="<?php echo round($ml, 3); ?>"
                                        placeholder="<?php echo $volume; ?>" readonly>
                                    pembulatan :
                                    <input type="text" name="hasil_rilis" id="hasil_rilis" size="7"
                                        style="font-family:monospace;" value="<?php echo round($ml, 0); ?>" readonly>
                                    <?php if ($var_volume_kantong == '1') { ?>
                                        ml
                                    <?php } else { ?>
                                        ml <font color="blue"><b>&radic;</b></font>
                                    <?php } ?>
                                </td>
                            </tr>

                            <tr>
                                <td style="background-color: mistyrose" colspan="2"><b>STATUS RELEASE</b></td>
                                <td>
                                    <?
                                    $sel1 = '';
                                    $sel2 = '';
                            ...
                            <tr>
                                <td style="background-color: mistyrose" colspan="2">Catatan</td>
                                <td><input type="text" name="catatan"></td>
                            </tr>
                            <tr>
                                <td style="background-color: mistyrose" colspan="2">Petugas</td>
                                <td>
                                    <? echo $namalengkap; ?>
                                </td>
                            ...
                            <tr>
                                <td style="background-color: mistyrose" colspan="2">Dicek oleh</td>
                                <td>
                                    <select name="dicekoleh" class="styled-select">
                                        ...
                                        while ($data1 = mysql_fetch_assoc($do1)) {
                                            ...
                                            <option value="<?= $data1[id_user] ?>" <?= $select ?>>
                                                <?= $data1[nama_lengkap] ?>
                                            </option>
                                        <?
                                        } ?>
                            ...
                            <tr>
                                <td style="background-color: mistyrose" colspan="2">Disahkan oleh</td>
                                <td>
    ...
    <script>
        /* !!!!!!!!!!!!!!!!!!!!!!!!!!!!!! */
        let tabList = ["kantong", "pemeriksaan", "pengolahan", "history", "visual"];
        let curTabIdx = 0;
    ...
    <script type="text/javascript">
        function hitungVolume() {
            var beratEl = document.getElementById('berat');
            var volAkhirEl = document.getElementById('vol_akhir');
            var hasilRilisEl = document.getElementById('hasil_rilis');

            var berat = 0;
            var beratkantongkosong = <?php echo json_encode($beratkantongkosong); ?>;
            var antikoagulant = <?php echo json_encode($antikoagulant); ?>;
            var beratjenis = <?php echo json_encode($beratjenis); ?>;
            var jeniskomponen = <?php echo json_encode($jeniskomponen); ?>;

            if (beratEl && beratEl.value !== '') {
                berat = parseFloat(String(beratEl.value).replace(',', '.'));
                if (isNaN(berat)) {
                    berat = 0;
                }
            }

            beratkantongkosong = parseFloat(beratkantongkosong);
            if (isNaN(beratkantongkosong)) {
                beratkantongkosong = 0;
            }

            antikoagulant = parseFloat(antikoagulant);
            if (isNaN(antikoagulant)) {
                antikoagulant = 0;
            }

            beratjenis = parseFloat(beratjenis);
            ...
            if (isNaN(ml) || !isFinite(ml)) {
                ml = 0;
            }

            if (volAkhirEl) {
                volAkhirEl.value = ml.toFixed(3);
            }

            if (hasilRilisEl) {
                hasilRilisEl.value = Math.round(ml);
            }
        }

        if (window.attachEvent) {
            window.attachEvent('onload', hitungVolume);
        } else {
            window.addEventListener('load', hitungVolume, false);
        }
    </script>
</body>
