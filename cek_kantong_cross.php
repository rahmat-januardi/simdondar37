...
//build query
$query = "SELECT noKantong,gol_darah,tgl_Aftap,produk,rhesusDrh, volume FROM stokkantong WHERE noKantong='$no_label' and Status='2' and (hasil_release='1' or hasil_release='3')";
//Execute query
