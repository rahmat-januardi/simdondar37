...
header("Content-Disposition: attachment; filename=qc-tcaf-all.xls");
...
<table align="right" border=1 cellpadding=4  style="border-collapse:collapse">
        <tr style="font-size:12px; color:#000000;">
	    <th colspan="2" align="left">Catatan : *Standar Kelulusan* <br/>Kadar Trombosit/Unit = > 2 x 10<sup>11</sup>
