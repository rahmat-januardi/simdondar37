...
`i-hiv`,`i-syp`,`qcuser`,`qcchecker`,`qcpengesah`,`qc_status`,`hsl_periksa_fisik`,`hasil_periksahem`,`v_hemolisis`,`v_lipemik`,`v_penggumpalan`,`v_warna`,`v_tdk`,`leukosit`)
...
'$v_qcpengesah','$v_rsatus_ket','$v_rfisik_ket','$v_rhematologi','$vi_hemolisis','$vi_lipemik','$vi_penggumpalan','$vi_warna','$vi_tdk','$v_rleukosit1')";
	    $qact=mysql_query($sql);
    ...
    if ($mode_kembali==1){
        echo "<meta http-equiv='refresh' content='2;url=pmiqc.php?module=menu_prc'>";
    } else{
        echo "<meta http-equiv='refresh' content='2;url=pmiqc.php?module=menu_prc'>";
    }
