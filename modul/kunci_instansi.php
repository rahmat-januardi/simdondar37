...
if ($td0 == 'M') {
	...
	if ($ninstan != 1) {
		echo $pesan = "<h1>SILAHKAN <b><a href=pmimobile.php?module=data_jadwal_mobile>PILIH INSTANSI</a></b>  SEBELUM MELANJUTKAN!!!</h1>";
	} else {

		$pesan = $instan01[nama];
?>
		<h1>Instansi telah di pilih
			<? echo $pesan ?>
		</h1>
		<br>
		<h2>Untuk Merubah Instansi Silahkan ulangi proses Download dengan Klik <a href="pmimobile?module=download">DISINI</a>
		</h2>
