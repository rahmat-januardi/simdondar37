...
if (isset($_POST[submit])) {
    ...
    $update_kantong = mysql_query("update stokkantong set kodePendonor='$pendonor', produk='$produk', tgl_Aftap='$tglaftap',
kadaluwarsa='$kadaluwarsa', kadaluwarsa_ktg='$expirektg', lama_pengambilan='$durasi', Status='$status', hasil='$hasilimltd', 
gol_darah='$goldarah', RhesusDrh='$rhesus', volume='$volume' where noKantong='$kode'");

    if ($update_kantong) {
        // ----- LOG AKSI (menggunakan user_log.php) -----
        $log_mdl   = $_SESSION['leveluser'];
        $log_aksi  = "Edit data kantong darah | No.Kantong: $kode | Kode Pendonor: $pendonor | Produk: $produk | Tgl Aftap: $tglaftap | Durasi: $durasi menit | Status: $status | volume: $volume";
...
<form name="masterbarang" method="POST" action="<?= $PHPSELF ?>">
    ...
    <table class="form" border="1" cellpadding=2 cellspacing=3>
        ...
        function dbar(browser) {
            ...
            document.masterbarang.volume.value = brg11;
        ...
        <tr>
            <td>No. Kantong</td>
            <td class="input"><input name="kode" readonly="readonly" type="text" size="20"
                    placeholder="Klik LUV cek data -->"> <a href="modul/cari_kantong2.php?&width=400&height=350"
                    class="thickbox"><img src="images/button_search.png" border="0" /></a> </td>
        </tr>

        <tr>
            <td>Kode Pendonor</td>
            <td class="input"><input name="pendonor" type="text" size="20"><a
                    href="modul/cari_donor2.php?&width=400&height=350" class="thickbox"><img
                        src="images/button_search.png" border="0" /></a></td>
        </tr>
        ...
        <tr>
            <td>volume kantong</td>
            <td class="input"><input name="volume" type="text" size="10">ml</td>
        </tr>


        <tr>
            <td>Status Kantong</td>
            <td class="input"><input name="status" type="text" size="10"><br />0:Kosong diaftap &nbsp; 1:Karantina
                &nbsp; 2:Sehat
                <br />3:Keluar &nbsp;
                <br />6:Musnah (jika status no 6, sebelum di update
                <br />wajib konfirmasi ke bagian IMLTD) &nbsp;
                <br />7:Karantina Reaktif
            </td>
        </tr>
