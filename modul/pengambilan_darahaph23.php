                    ...
                    <?php
                                ...
                                WHERE (Status='1' and NoTrans='$notrans')";
                                                                                                        ...
                                                                                                        if ($sk2query) {
                                                                                                            //=======Audit Trial====================================================================================
                                                                                                            $log_mdl = 'PENGAMBILAN';
                                                                                                            $log_aksi = 'Pengambilan darah Apheresis: ' . $notrans . ' Pendonor: ' . $kodependonor . ' Kantong: ' . $id_kantong . ' status: ' . $keberhasilan;
                                                                                                            include_once "user_log.php";
                                                                                                            //=====================================================================================================
                    ?>
                            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-12" align="center">
                                <div class="panel-title">
                                    <h4><strong>PENYADAPAN DARAH PENDONOR APHERESIS</strong></h4>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control" name="kodependonor"
                                                value="<?php echo $check1[KodePendonor]; ?>" id="iddonor" readonly
                                                required>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="radio-custom radio-primary">
                                                <label class="radio-inline"><input type="radio" id="inlineRadio1"
                                                        value="0" name="keberhasilan" style="margin-top:1px;"
                                                        required>Berhasil</label>
                                                <label class="radio-inline"><input type="radio" id="inlineRadio2"
                                                        value="1" name="keberhasilan"
                                                        style="margin-top:1px;">Batal</label>
                                                <label class="radio-inline"><input type="radio" id="inlineRadio3"
                                                        value="2" name="keberhasilan"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-3">
                                            <input name="selesai" value="" class="form-control" id="jam_ambil"
                                                placeholder="mm:dd" autocomplete="off" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input name="id_kantong11" id="id_kantong11" onkeypress="search(event)"
                                                class="form-control" autocomplete="off" placeholder="Nomor Kantong"
                                                required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input name="no_selang" id="no_selang" onkeydown="chang(event,this);"
                                                class="form-control" autocomplete="off" placeholder="Nomor Selang"
                                                required>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-8">
                                            <select class="form-control" name="petugas" required>
                                                ...
                                                while ($ptgsaft = mysqli_fetch_array($aftaper)) { ?>
                                                    <option class="form-control" value=<?php echo $ptgsaft['id_user']; ?>>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control" value="<?php echo $check1[suhu]; ?>"
                                                readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
