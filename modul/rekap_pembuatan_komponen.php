        ...
        <div class="rekap-hero-inner">
            ...
            <div class="rekap-hero-sub">
                <span class="rekap-badge">
                    ...
                    <?php echo $pertgl ?>-<?php echo $perbln ?>-<?php echo $perthn ?> s/d
            ...
            <form name="mintadarah1" method="post">
                <div class="filter-row">
                    <div class="filter-group">
                        ...
                        <input type="text" name="minta1" id="datepicker" placeholder="yyyy-mm-dd"
                            value="<?php echo $today ?>">
                    </div>
                    <div class="filter-group">
                        <label>Tanggal Sampai</label>
                        <input type="text" name="minta2" id="datepicker1" placeholder="yyyy-mm-dd"
                ...
                ");
                    ...
                    ";
							...
							if ($kategori == 'Pemutar') {
								...
								$baseAlat .= " AND Produk NOT LIKE '%PRC%' AND Produk NOT LIKE '%WB%'";
							}
        ...
        <div class="section-card">
            <div class="section-header">
                <div class="section-icon">
                    <svg viewBox="0 0 24 24">
                        <path
                            d="M20 7H4a2 2 0 00-2 2v10a2 2 0 002 2h16a2 2 0 002-2V9a2 2 0 00-2-2zm-9 8H7v-2h4v2zm6-4H7v-2h10v2z" />
                    </svg>
                </div>
                <div>
