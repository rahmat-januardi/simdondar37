...
if (($_SESSION[leveluser]) == 'laboratorium') { ?>
    ...
    switch ($_GET[act]) {
        ...
        default:
            ...
            //LAPORAN LTTTD DS & DP dari tanggal pengambilan 
            ...
            //pindah stokk hasil incomp
            elseif ($_GET[module] == 'pindah_stok') {
                include  "modul/kembali_stok.php";
            }

            //pndah stok salah buang
            elseif ($_GET[module] == 'pindah_stok_salahbuang') {
                include  "modul/kembali_stok_salahbuang.php";
            }
            //Manual
            ...
            // Ubah Status Kantong
            elseif ($_GET[module] == 'ubah_status_kantong') {
                include "modul/ubah_status_kantong.php";
            }

            // musnah kantong
            elseif ($_GET['module'] == 'laborat_musnah') {
