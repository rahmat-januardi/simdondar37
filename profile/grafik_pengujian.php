...
<head>
    ...
    function downloadAsImg(fileName) {
        exportGrafik(function(imgData) {
            ...
            link.href = imgData;
            link.download = (fileName ? fileName : 'grafik-pengujian') + '.png';
    ...
    function printChart(judul) {
        exportGrafik(function(imgData) {
            ...
            printWindow.document.write(
                '<html><head><title>' + (judul ? judul : 'Grafik Pengujian') + '</title></head>' +
...
<body>
    ...
    function drawChart() {
        var data = google.visualization.arrayToDataTable([
            ['Bulan', 'Sesuai/Cocok', 'Tidak Sesuai/Tidak Cocok'], <?php echo $data; ?>
        ]);
        var options = {
            'title': '',
            width: 750,
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel with-nav-tabs panel-primary" id="shadow1">
                    ...
                    <form class="form-inline" method="POST" action="<?= $self ?>?module=graphpengujian">
                        ...
                        <div class="panel-footer">
                            ...
                            <button type="button" class="btn btn-default class_shadow2"
                                onclick="downloadAsImg('grafik-pengujian-<?php echo date("Ymd"); ?>');"><i
