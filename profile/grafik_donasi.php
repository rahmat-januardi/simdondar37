...
<head>
    ...
    function downloadAsImg(fileName) {
        exportGrafik(function(imgData) {
            ...
            link.href = imgData;
            link.download = (fileName ? fileName : 'grafik-donasi') + '.png';
    ...
    function printChart(judul) {
        exportGrafik(function(imgData) {
            ...
            printWindow.document.write(
                '<html><head><title>' + (judul ? judul : 'Grafik Donasi') + '</title></head>' +
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel with-nav-tabs panel-primary" id="shadow1">
                    ...
                    <form class="form-inline" method="POST" action="<?= $self ?>?module=graphdonasi">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <select class="form-control" name="modelgraph">
                                        ...
                                        <option value="8" <?= $s8 ?>>Pie Chart Penyumbangan berhasil/gagal/batal
                                        </option>
                        ...
                        <div class="panel-footer">
                            <button type="submit" name="submit" id="btn_upload" class="btn btn-default class_shadow2"><i
                                    class="fa  fa-pie-chart" aria-hidden="true"></i>&nbsp;&nbsp;Tampilkan
                                Grafik</button>
                            ...
                            <button type="button" class="btn btn-default class_shadow2"
                                onclick="downloadAsImg('grafik-donasi-<?php echo date("Ymd"); ?>');"><i
