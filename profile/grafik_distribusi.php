...
<head>
    ...
    function exportGrafik(callback) {
        ...
        // Beri jeda sedikit supaya animasi chart (is3D, dsb.) benar-benar selesai digambar
        // sebelum di-screenshot, karena Google Chart menggambar secara async.
        setTimeout(function() {
            html2canvas(area, {
    ...
    function downloadAsImg(fileName) {
        exportGrafik(function(imgData) {
            ...
            link.href = imgData;
            link.download = (fileName ? fileName : 'grafik-distribusi') + '.png';
    ...
    function printChart(judul) {
        exportGrafik(function(imgData) {
            ...
            printWindow.document.write(
                '<html><head><title>' + (judul ? judul : 'Grafik Distribusi') + '</title></head>' +
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel with-nav-tabs panel-primary" id="shadow1">
                    ...
                    <form class="form-inline" method="POST" action="<?= $self ?>?module=graphdistribusi">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <select class="form-control" name="modelgraph">
                                        ...
                                        <option value="2" <?= $s2 ?>>Grafik Status Pemeriksaan Uji Silang Serasi
                                        </option>
                                        <option value="3" <?= $s3 ?>>Grafik Sebaran Pendistribusian Darah</option>
                                        <option value="4" <?= $s4 ?>>Grafik Pengeluaran Darah berdasarkan Bagian di
                                            Rumah Sakit</option>
                                        <option value="5" <?= $s5 ?>>Grafik Pengeluaran Darah berdasarkan Wilayah Rumah
                                            Sakit</option>
                                    </select>
                        ...
                        <div class="panel-footer">
                            ...
                            <button type="button" class="btn btn-default class_shadow2"
                                onclick="downloadAsImg('grafik-distribusi-<?php echo date("Ymd"); ?>');"><i
