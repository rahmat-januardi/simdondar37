                ...
                <div class="panel with-nav-tabs panel-primary" id="shadow1">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-lg-6">
                                <div>
                                    <h4 style="text-transform: uppercase;">LAPORAN DONASI APHERESIS</h4>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="panel-title pull-right">
                                    <form class="form-inline" method="POST"
                                        action="pmitatausaha.php?module=lap_donasi_aph">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <?php
                                $q_dnr = "SELECT
                                sum(case when (h.`JenisDonor`='0' and (h.`tempat`='0' or h.`tempat` in ('2','3','M'))) then 1 else 0 end ) as dg_ds,
                                sum(case when (h.`JenisDonor`='1' and (h.`tempat`='0' or h.`tempat` in ('2','3','M'))) then 1 else 0 end ) as dg_dp,
                                sum(case when (h.`donorbaru`='0') then 1 else 0 end ) as dnr_baru,
                                sum(case when (h.`donorbaru`='1') then 1 else 0 end ) as dnr_ulang,
                                sum(case when (h.`tempat`='0') then 1 else 0 end ) as dnr_dg,
                                sum(case when (h.`tempat` in ('2','3','M')) then 1 else 0 end ) as dnr_mu,
                    ...
                    <div class="panel-footer">
                        ...
                        <a href="pmitatausaha.php?module=rpt_donasi_aph&thn=<?php echo $v_tahun; ?>&bln=<?php echo $v_bulan; ?>"
