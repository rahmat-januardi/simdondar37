...
<body>
    ...
    <?
                        ...
                        case '4':
                            ...
                            while ($res = mysql_fetch_array($query)) {
                                $golongan = $res['GolDarah'];
                                $jumlah = $res['jml'];
                                $data .= '["' . $golongan . '",' . $jumlah . '],';
                            }
                            $data = substr($data, 0, (strlen($data) - 1));
                            $s4 = "selected";
                            ?>
    ...
    function drawChart() {
        var data = google.visualization.arrayToDataTable([
            ['Bulan', 'Target', 'Donasi'], <?php echo $data; ?>
        ]);
        var options = {
            'title': '',
            width: 750,
                    ...
                    <form class="form-inline" method="POST" action="pmitatausaha.php?module=graphdonor">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <select class="form-control" name="modelgraph">
                                        <option value="1" <?= $s1 ?>>Grafik Jumlah Pendonor Berdasarkan Pekerjaan
                                        </option>
                                        <option value="2" <?= $s2 ?>>Grafik Jumlah Pendonor Berdasarkan Donasi</option>
                                        <option value="3" <?= $s3 ?>>Grafik Jumlah Pendonor Berdasarkan Rentang Umur
                                        </option>
                                        <option value="4" <?= $s4 ?>>Grafik Jumlah Pendonor Berdasarkan Golongan Darah
                                            ABO</option>
                                        <option value="5" <?= $s5 ?>>Grafik Jumlah Pendonor Berdasarkan Golongan Darah
                                            Rhesus</option>
                                        <option value="6" <?= $s6 ?>>Grafik Jumlah Pendonor Berdasarkan Jenis Kelamin
                                        </option>
                                        <option value="7" <?= $s7 ?>>Grafik Perbandingan Target Mobile Unit dengan
                                            Perolehan Darah</option>
                                        <option value="8" <?= $s8 ?>>Grafik Jumlah Kegiatan Mobile Unit per Bulan
                                        </option>
                                    </select>
                                    Tahun
                                    <input class="form-control" name="tahun" id="datepicker" value="<?= $v_tahun ?>"
                                        type=date size=10><small>Tidak berlaku untuk seluruh grafik</small>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
                                    <h4 style="color: red;font-weight: bold;"><?php echo $title . ' ' . $title2; ?></h4>
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="panel-footer">
                            <button type="submit" name="submit" id="btn_upload" class="btn btn-default class_shadow2"><i
                                    class="fa fa-pie-chart" aria-hidden="true"></i>&nbsp;&nbsp;Tampilkan Grafik</button>
                            <button type="button" class="btn btn-default class_shadow2"
                                onclick="saveAsImg(document.getElementById('chart_div'));"><i class="fa  fa-save"
                                    aria-hidden="true"></i>&nbsp;&nbsp;Simpan Grafik</button>
                            <a href="pmitatausaha.php?module=statistik" class="btn btn-default class_shadow2"
