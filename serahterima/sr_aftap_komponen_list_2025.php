                                    ...
                                    <table
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_assoc($query)) {
                                                ...
                                                echo '<a href="serahterima/sr_aftap_export_json.php?noTransaksi=' . $row['hst_notrans'] . '" class="btn-export"> | EXPORT JSON</a>';
                                                if ($row['up_data'] == '0') {
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header w3-green shadow">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title" style="color:white;">Import Data dari File JSON</h4>
                </div>
                <div class="modal-body">
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.status === 'success') {
                    ...
                    Swal.fire("Gagal", response.message || "Terjadi kesalahan saat import", "error");
                }
            },
