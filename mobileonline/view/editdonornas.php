...
if ($unit == "" || $id === "") {
  ...
  if (isset($_POST['proses'])) {
    ...
    if ($cekal_data['Cekal'] == '1') {
      ...
      //insert htransaksi
      if ($lanjut == '0' && date('Y-m-d') >= $data['ptglkembali']) {
            ...
            <div class="col-lg-6">
              <div class="table-responsive">
                <table width=100%>
                  <tr>
                    <td>Kode Pendonor</td>
                    <td class="warning"><input type="text" name="kodep" class="form-control" value=<?php echo $data['pkode']; ?> readonly></td>
                  </tr>
                  <tr>
                    <td>No. KTP</td>
                    <td class="warning"><input type="text" name="ktp" class="form-control" value=<?php echo $data['pnoktp']; ?>>
                  ...
                  <tr>
                    <td>Nama Pendonor</td>
                    <td class="warning text-danger"><strong><input type="text" name="namap" class="form-control" value="<?php echo $data['pnama']; ?>"></strong></td>
                  </tr>
                  <tr>
                    <td>Jenis Kelamin</td>
                    <td class="warning">
                  ...
                  <tr>
                    <td>Alamat</td>
                    <td class="warning"><input type="text" name="alamat" class="form-control" value="<?php echo $data['palamat']; ?>"></td>
                  </tr>
                  <tr>
                    <td>Kelurahan</td>
                    <td class="warning"><input type="text" name="kel" class="form-control" value="<?php echo $data['pkelurahan']; ?>"></td>
                  </tr>
                  <tr>
                    <td>Kecamatan</td>
                    <td class="warning"><input type="text" name="kec" class="form-control" value="<?php echo $data['pkecamatan']; ?>"></td>
                  </tr>
                  <tr>
                    <td>Wilayah</td>
                    <td class="warning"><input type="text" name="wil" class="form-control" value="<?php echo $data['pwilayah']; ?>"></td>
                  </tr>
                </table>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="table-responsive">
                <table width=100%>
                  <tr>
                    <td>No. Handphone</td>
                    <td class="warning"><input type="text" name="telp" class="form-control" value="<?php echo $data['ptelp2']; ?>"></td>
                  </tr>
                  <tr>
                    <td>Tempat Lahir</td>
                    <td class="warning"><input type="text" name="tmp_lhr" class="form-control" value="<?php echo $data['ptempatlahir']; ?>"></td>
                  </tr>
                  <tr>
                    <td>Tanggal Lahir</td>
                    <td class="warning"><input type="text" name="tgl_lhr" id="datepicker" style="width:4cm;height:0.75cm" class="form-control" value="<?php echo $data['ptgllahir']; ?>"></td>
                  </tr>
                  <tr>
                    <td>Pekerjaan</td>
                    <td class="warning">
