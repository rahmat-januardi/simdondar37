  ...
  if (valid_kantong0 == "1") {
    for (var i = 0; i < jsplit; i++) {
      ...
      function kadaluwarsa1(rc) {
        ...
        if (jkomp == "PRC") tgl0 = Date.parse(tgl_aftap0).add(35).days();
        ...
        if (jkomp == "AHF") tgl0 = Date.parse(tgl_aftap0).add(5).days();
        if (jkomp == "LP") tgl0 = Date.parse(tgl_aftap0).add(35).days();
        if (jkomp == "BC") tgl0 = Date.parse(tgl_aftap0).add(5).days();
