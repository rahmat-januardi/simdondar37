...
function cari_form() {
  ...
  if (no_form1 == "") {
    alert(
      "Formulir tidak ditemukan atau permintaan telah dipenuhi, Silahkan cek kembali nomor formulir",
    );
    document.cek_form.NoForm.value = "";
  }
  if (jsudahcross0 >= jminta0 && no_form1 !== "") {
    alert(
      "Formulir permintaan telah dipenuhi, Silahkan cek kembali nomor formulir",
    );
    document.cek_form.NoForm.value = "";
  }
...
function cari_kantong(tableID) {
  ...
  $.ajax({
    ...
    success: function (json) {
      ...
      createCookie("volume_darah", volume, 7);
    },
  });
  if (no_label1 != "") {
    var i;
...
function addRow(tableID) {
  ...
  var element31 = document.createElement("input");
  var vol = readCookie("volume_darah");
  element31.type = "text";
  element31.size = "4";
  element31.name = "volume[]";
  element31.value = vol;
  cell31.appendChild(element31);
