...
if((isset($_POST[submit])) and ($_POST[berat_ku]!=="")){
    ...
    $sql="SELECT `id`, `merk`, `jenis`,
          case `jenis`
            ...
            end as jeniskantong,  `ket`,
            `berat_ku`, `berat_s1`, `berat_s2`, `berat_s3`, `berat_s4`, `berat_s5`, `berat_s6`, `berat_s7`, lama_buka, vol, antkogulan
          FROM `master_kantong_qc` WHERE id='$no_id'";
	...
	<table class="form" cellspacing="1" cellpadding="0" border="1">
        ...
        <tr>
            ...
            <td class="input"><input name="antkogulan" type="text" size="15" value="<?=$sq10[antkogulan]?>"></td>
        </tr>
		<tr>
