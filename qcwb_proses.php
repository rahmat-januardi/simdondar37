...
<body>
    ...
    if (isset($_POST['Button'])) {
        ...
        $v_tglpengolahan = $_POST['tglpengolahan'];
        ...
        if (isset($_POST['visual']) && is_array($_POST['visual'])) {
            // Ambil semua nilai checkbox dan gabungkan dengan koma
            $v_rvisual = implode(", ", $_POST['visual']);
            // echo "Hobi yang dipilih: " . $v_rvisual;
        } else {
            $v_rvisual = "Tidak Ada";
        }
        ...
        switch ($v_rhasil_hematologi) {
            case '0':
                ...
                break;
            case '1':
                $v_rhematologi = 'Tidak Lulus';
                $v_statusktg = '2';
                break;
        }


        $histori = mysql_query("insert into histori (`username`,`waktu`,`action`,`level_editor`,`nokantong`) values ('$namauser','$v_rtgl','Sampel $nkt telah di QC dengan hasil $v_rsatus_ket','QC','$nkt')");
		...
		`anaerob`	    ='$v_anaerob'
            ...
            $sql = "INSERT INTO `qc`(`notrans`, `qctgl`, `nokantong`, `jenis`, `merk`, `gol_darah`, `RhesusDrh`, `produk`, `tglaftap`, `tglpengolahan`, `kadaluwarsa`, `tgledkantong`, `berat_isi`, `berat_kosong`, `berat_jenis`, `antikogulan`, `volume`, `volhem`, `kadhb`, `hct`, `plasma`, `ttlhb`, `hemolisis`, `hemoglobin`, `aerob`, `anaerob`, `kebocoran`, `visual`, `i-hbs`, `i-hcv`, `i-hiv`, `i-syp`, `qcuser`, `qcchecker`, `qcpengesah`, `qc_status`, `hsl_periksa_fisik`, `hasil_periksahem`, `up_data`)
          VALUES ('$v_rnotrans','$v_rtgl','$nkt','$v_jenis','$v_merk','$v_goldarah','$v_rhesus','$v_rproduk','$v_tglaftap', '$v_tglpengolahan', '$v_kadaluwarsa',
'$v_tgledkantong','$v_beratisi','$v_beratkosong','$v_beratjenis','$v_antikogulan','$v_volume', '$v_volhem', '$v_kadhb', '$v_hct','$v_plasma','$v_ttlhb','$v_hemolisis', '$v_hemoglobin','$v_aerob','$v_anaerob', '$v_kebocoran', '$v_rvisual', '$v_ihbs', '$v_ihcv','$v_ihiv','$v_isyp','$v_qcuser','$v_qcchecker',
'$v_qcpengesah','$v_rsatus_ket','$v_rfisik_ket','$v_rhematologi', '1')";
            $qact = mysql_query($sql);
    ...
    <form name="form_prolis" align="left" method="post" action="<? echo $PHPSELF ?>">
        ...
        <script>
            function hitung() {
                ...
                document.form_prolis.volume.value = Math.round(total2);
                var tVolhem1 = (total2 + update2) / 100;
                document.form_prolis.volhem.value = tVolhem1.toFixed(2);
                ...
                <tr>
                    <td valign="top">
                        <table width="100%" cellpadding="5" cellspacing="5">
                            ...
                            <input type='hidden' name='tglpengolahan' value='<?= $tglpengolahankomponen ?>'>
                            ...
                            <input type='hidden' name='kebocoran' value='-'>

                            <tr>

                                <td style="background-color: mistyrose" colspan="2">Berat Kantong Isi</td>
                                <td class="input"><input onchange="hitung()" name="beratisi" type="text" size="5"
                                        placeholder="Isi Angka">gram</td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input onchange="hitung()" name="beratkosong" type="text" size="5"
                                        placeholder="Isi Angka" value="<?= $beratkantongkosong ?>" required=""
                                        readonly="readonly">gram
                                </td>
                            </tr>
                            <tr>
                                <td style="background-color: mistyrose" colspan="2">Berat Jenis</td>
                                <td>
                                    <input type="hidden" name="korek" value="plus">
                                    <input type="hidden" name="korek" value="min" checked="checked">
                                    <input onchange="hitung()" name="beratjenis" type="text" size="5"
                                        placeholder="Isi Angka" value="<?= $beratjenis ?>" required=""
                                        readonly="readonly">gram
                                </td>
                            </tr>

                            <tr>
                                <td style="background-color: mistyrose" colspan="2">Antikogulan</td>
                                <td>
                                    <input type="hidden" name="korek" value="plus">
                                    <input type="hidden" name="korek" value="min" checked="checked">
                                    <input onchange="hitung()" name="antikogulan" value="<?= $antkogulan ?>" type="text"
                                        size="5" placeholder="Isi Angka" required="" readonly="readonly">gram
                                </td>
                            </tr>

                            <tr>
                                <td style="" colspan="2">Hasil Perhitungan Volume</td>
                                <td class="input"><input name="volume" type="text" size="5" readonly="readonly"
                                        style="background-color:#BDB76B" ;>ml</td>
                            ...
                            <tr>
                                <td style="background-color: mistyrose" colspan="2">HCT</td>
                                <td><input onchange="hitung()" type="text" size="5" placeholder="Isi Angka" name="hct">
                                    <input onchange="hitung()" type="hidden" size="5" name="hct1" readonly="readonly">
                                </td>
                            </tr>

                            <tr>
                                <td style="background-color: mistyrose" colspan="2">Total Plasma Low HB</td>
                                <td><input onchange="hitung()" type="text" size="5" placeholder="Isi Angka"
                                        name="plasma"></td>
                            </tr>

                            <tr>
                                <td style="background-color: mistyrose" colspan="2">Total HB</td>
                                <td><input onchange="hitung()" type="text" size="5" placeholder="Isi Angka"
                                        name="ttlhb"></td>
                            </tr>

                            <tr>
                                <td style="" colspan="2">Hasil Perhitungan Hemolisis</td>
                                <td><input type="text" size="2" name="hemolisis" style="background-color:yellow" ;>%
                                    <!--<input type="text" size="35" placeholder="Isi Disini Bila Dilakukan Secara Manual" name="hemolisis1">%-->
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="checkbox" name="visual[]" id="vi_hemolisis"
                                        value="Hemolisis" />Hemolisis<div class="control_indicator"></div><br />
                                    <input type="checkbox" name="visual[]" id="vi_lipemik" value="Lipemik" />Lipemik<div
                                        class="control_indicator"></div><br />
                                    <input type="checkbox" name="visual[]" id="vi_penggumpalan"
                                        value="Penggumpalan" />Penggumpalan<div class="control_indicator"></div><br />
                                    <input type="checkbox" name="visual[]" id="vi_warna"
                                        value="Perubahan Warna" />Perubahan Warna<div class="control_indicator"></div>
                                    <br />
                                    <input type="checkbox" name="visual[]" id="vi_tdk" value="Tidak Ada" />Tidak Ada<div
                                        class="control_indicator"></div>
                                </td>
                            </tr>

                            <tr>
                                <td style="background-color: mistyrose" colspan="2">Hasil Pemeriksaan Fisik</td>
                                <td>
                ...
                <tr>
                    <td valign="top">
                        <table width="100%" cellpadding="5" cellspacing="5">
                            ...
                            <tr>
                                <td style="background-color: mistyrose" colspan="2">Volume</td>
                                <td><input type="text" onchange="hitung()" placeholder="Isi Angka" name="volhem"
                                        required="" size="5">g/unit</td>
                            </tr>
                            <tr>
                                <td style="background-color: mistyrose" colspan="2">Kadar HB</td>
                                <td><input type="text" onchange="hitung()" placeholder="Isi Angka" name="kadhb"
                                        required="" size="5">g/unit</td>
                            </tr>
                            <tr>
                                <td style="" colspan="2">Hemoglobin</td>
                                <td><input type="text" onchange="hitung()" readonly="readonly" name="hemoglobin"
                                        size="5" style="background-color:#BDB76B" ;>g/unit</td>
                            </tr>

                            <tr>
                                <td style="background-color: mistyrose" colspan="2">Hasil Pemeriksaan Hematologi</td>
                                <td>
            ...
            <table cellpadding=4 cellspacing=4 width="100%" style="border: 0px; border-color: #ffffff;">
                <tr>
                    <td valign="top">
                        <table width="100%" cellpadding="5" cellspacing="5">
                            <tr>
                                <td style="background-color: mistyrose" colspan="2">Aerob</td>
                                <td>
                            ...
                            <tr>
                                <td style="background-color: mistyrose" colspan="2">Anaerob</td>
                                <td>
                            ...
                            <tr>
                                <td style="background-color: mistyrose" colspan="2">Hasil QC</td>
                                <td>
                            ...
                            <tr>
                                <td style="background-color: mistyrose" colspan="2">Petugas Yg Mengerjakan</td>
                                <td>
                                    <? echo $namalengkap; ?>
                                </td>
                                <input type="hidden" name="petugas" value=<?= $namalengkap ?>>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <select name="dicek" class="styled-select">
                                        ...
                                        while ($data1 = mysql_fetch_assoc($do1)) {
                                            ...
                                            <option value="<?= $data1[nama_lengkap] ?>" <?= $select ?>><?= $data1[nama_lengkap] ?>
                                            </option>
                                        <?
                                        } ?>
                                    </select>
